...
parser.add_argument("-z", help="Return the clien't time zone as part of the Key/Value pair", action="store_true")
parser.add_argument("-m", help="Return the request method as part of the Key/Value pair", action="store_true")
parser.add_argument("-q", help="Return the request's query strings part of the Key/Value pair", action="store_true")
...
for line in sys.stdin:
        ...
        [ip, identity, username, time, zone, method, query, protocol, status, size] = data
        ...
        if sys.argv[1]=="-ip":
                ...
                returnValues[0]=method
        elif sys.argv[1]=="-q":
                returnValues[0]=query
        elif sys.argv[1]=="-p":
                returnValues[0]=protocol
        elif sys.argv[1]=="-c":
        ...
        if sys.argv[2]=="-ip":
                ...
                returnValues[1]=method
        elif sys.argv[2]=="-q":
                returnValues[1]=query
        elif sys.argv[2]=="-p":
                returnValues[1]=protocol
        elif sys.argv[2]=="-c":
